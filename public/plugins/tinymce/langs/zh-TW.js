...
tinymce.addI18n('zh-TW', {
	...
	"The URL you entered seems to be an email address. Do you want to add the required mailto:prefix?": "你所填寫的URL位址為電郵地址，需要加上mailto:首碼嗎？",
	...
	"System Font": "系統字體",
	"Failed to upload image:{0}": "圖片上載失敗:{0}",
	...
	"Color swatch": "顏色樣本",
	"Color Picker": "選色器",
	"Invalid hex color code:{0}": "十六進位顏色代碼無效： {0}",
	"Invalid input": "無效輸入",
	"R": "R",
	"Red component": "紅色部分",
	"G": "G",
	...
	"Loading...": "載入中...",
	"ImageProxy HTTP error:Rejected request": "圖片代理請求錯誤：請求被拒絕",
	"ImageProxy HTTP error:Could not find Image Proxy": "圖片代理請求錯誤：無法找到圖片代理",
	"ImageProxy HTTP error:Incorrect Image Proxy URL": "圖片代理請求錯誤：圖片代理位址錯誤",
	"ImageProxy HTTP error:Unknown ImageProxy error": "圖片代理請求錯誤：未知的圖片代理錯誤"
});